...
#[utoipa::path(
    ...
    responses(
        ...
        (status = 422, description = "The username is missing or blank", body = crate::problem::Problem),
        (status = 429, description = "Rate limited, counted per username", body = crate::problem::Problem)
    )
)]
